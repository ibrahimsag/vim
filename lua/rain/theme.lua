local blend = require('rain.util').blend

local M = {}

function M.get(config)
	local p = require('rain.palette')
	...
	theme = {
		...
		TSOperator = { fg = p.rose },
		TSParameter = { fg = p.step, style = styles.italic },
		-- TSParameterReference = {},
		TSProperty = { fg = p.step, style = styles.italic },
		...
		['@number'] = { link = 'Number' },
		['@operator'] = { fg = p.rose },
		['@parameter'] = { fg = p.step, style = styles.italic },
		['@property'] = { fg = p.step, style = styles.italic },
